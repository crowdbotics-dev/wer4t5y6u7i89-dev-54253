...
## Project Structure
    ...
    ├── wer4t5y6u7i89_dev_54253  # Django project configurations
...
1. Clone this repo and `cd wer4t5y6u7i89_dev_54253`
...
2. Clone this repo and `cd wer4t5y6u7i89_dev_54253`
